package com.vtgarment.model.dao.erp;
...
public abstract class GenericERPDAO<T, ID extends Serializable> implements Serializable{
    @Resource private SessionFactory sessionFactoryERP;
    ...
    protected Session getSession() throws Exception {
        return sessionFactoryERP.getCurrentSession();
    }
